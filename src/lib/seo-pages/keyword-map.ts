...
const BLOG_CANONICAL: KeywordMapEntry[] = [
  ...
  },
  {
    ...
    pageType: "blog",
    source: "created",
    reason: "Gaz dolumu bilgi niyeti; eyüpsultan/alibeyköy/göktürk klima servisi ticari sayfalarından ayrı canonical.",
  },
  {
    query: "klima gaz doldurma",
    href: "/blog/klima-gazi-ne-zaman-doldurulur",
    pageType: "blog",
    source: "created",
    reason: "Gaz doldurma bilgi niyeti blogda; konum+hizmet landing'e yönlendirilmez.",
  },
  {
    query: "klima gazı bitti",
    href: "/blog/klima-gazi-ne-zaman-doldurulur",
    pageType: "blog",
    source: "created",
    reason: "Gaz bitti araması bilgi niyeti; soğutmama arıza rehberi destekleyici kalır.",
  },
  {
    query: "klima gaz kaçağı belirtileri",
    href: "/blog/klima-gazi-ne-zaman-doldurulur",
    pageType: "blog",
    source: "created",
    reason: "Kaçak belirti niyeti gaz dolumu yazısında karşılanır.",
  },
  {
